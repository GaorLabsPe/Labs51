...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-[#111439] overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 sm:py-24 md:py-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl leading-tight sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#F8F8F9] mb-6 animate-fadeInUp" style={{animationDelay: '0.1s'}}>
